...
// headChat----------------------------------
const helpImg = document.getElementById("helpBtnImg");
...
function sendMessage() {
  ...
  messages.innerHTML += `<div id="typing" class="message bot typing">System is typing...</div>`;
  ...
  setTimeout(() => {
    ...
    typingDiv.innerHTML = `<strong>System:</strong> ${reply}`;
    messages.scrollTop = messages.scrollHeight;
  }, 1000);
}
...
function generateReply(msg) {
  ...
  if (text.includes("hi")) return "Hello! How can I assist you today?";
  else if (text.includes("number"))
    return "+918759417243 you can call me With no Hasitate!";
  else if (text.includes("contact"))
    return "You can reach support at whatsapp No.";
  return "Let me check that for you...Wait";
}
